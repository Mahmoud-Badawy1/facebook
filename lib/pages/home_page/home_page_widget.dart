...
import '/components/show_story/show_story_widget.dart';
                                  ...
                                  Flexible(
                                    child: StreamBuilder<List<StoryRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<StoryRecord> rowStoryRecordList =
                                            snapshot.data!;
                                        return SingleChildScrollView(
                                          ...
                                          child: Row(
                                            ...
                                            children: List.generate(
                                                rowStoryRecordList.length,
                                                (rowIndex) {
                                              final rowStoryRecord =
                                                  rowStoryRecordList[rowIndex];
                                              return ShowStoryWidget(
                                                key: Key(
                                                    'Keyqd8_${rowIndex}_of_${rowStoryRecordList.length}'),
                                              );
                                            }),
                                          ),
                                        );
                                    ...
                                    return ListView.separated(
                                      ...
                                      itemBuilder: (context, listViewIndex) {
                                        ...
                                        return Padding(
                                          ...
                                          child: PostsWidget(
                                            key: Key(
                                                'Keyy5q_${listViewIndex}_of_${listViewPostsRecordList.length}'),
                                          ),
                                        );
                                      },
                                    );
