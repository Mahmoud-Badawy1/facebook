...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const HomePageWidget() : const RegesterWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'Regester',
          path: '/regester',
          builder: (context, params) => const RegesterWidget(),
        ),
        FFRoute(
          name: 'CompleteReg',
          path: '/completeReg',
          builder: (context, params) => const CompleteRegWidget(),
        ),
        FFRoute(
          name: 'postPage',
          path: '/postPage',
